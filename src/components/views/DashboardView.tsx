          ...
          <div className="flex items-center gap-2 self-start sm:self-auto flex-wrap">
            {onNavigateToIntel && (
              <button
                ...
                className="inline-flex items-center gap-2 rounded-lg border border-purple-700/60 bg-purple-900/30 px-3.5 py-2 text-xs font-medium text-purple-300 hover:bg-purple-800/40 hover:text-white transition-colors whitespace-nowrap"
              >
            ...
            {onNavigateToEvidence && (
              <button
                ...
                className="inline-flex items-center gap-2 rounded-lg border border-indigo-700/60 bg-indigo-900/30 px-3.5 py-2 text-xs font-medium text-indigo-300 hover:bg-indigo-800/40 hover:text-white transition-colors whitespace-nowrap"
              >
            ...
            <button
              ...
              className="inline-flex items-center gap-2 rounded-lg border border-sky-700/60 bg-sky-900/40 px-3.5 py-2 text-xs font-medium text-sky-300 hover:bg-sky-800/50 hover:text-white transition-colors whitespace-nowrap"
            >
